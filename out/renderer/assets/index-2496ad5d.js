...
const LoginButton = () => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "button__login", onClick: handleLogin, children: "Log In" });
};
function Landing() {
  function handleClick() {
    alert("Button has been clicked");
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col w-screen h-screen justify-center items-center", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-4xl text-white font-bold", children: "Landing Page" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "p-4 m-4 border-2 border-white rounded-lg", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/home", children: "Go to Home page" }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: handleClick, className: "p-4 m-4 border-2 border-white rounded-lg", children: "Play" }),
...
async function getUserById(id2) {
  console.log(id2);
  const response = await fetch(`http://localhost:3000/users/${id2}`, {
    method: "get"
  });
  if (response.ok) {
    let responseJson = [];
...
async function getChallengeById(id2) {
  console.log(id2);
  const response = await fetch(`http://localhost:3000/challenges/${id2}`, {
    method: "get"
  });
  if (response.ok) {
    let responseJson = [];
...
function Challenge({ id: id2 }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, { children: isLoaded && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { children: challenge.title }),
...
function Home() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "flex items-center justify-center text-5xl m-5", children: "Welcome to Social Challenge" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "flex items-center justify-center text-xl m-5", children: "Complete this challenge for a chance to win a prize!" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Challenge, { id: "65466b9f02b1db375924b1b7" })
  ] });
}
...
function Profile() {
  ...
  reactExports.useEffect(() => {
    async function grabUser() {
      let user2 = await getUserById("6546a4e5656a25a752da06e7");
      console.log(user2);
      setUser(user2.data);
    }
    grabUser();
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { children: "This is the profile page" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("input", { onChange: (e2) => setUsername(e2.target.value), placeholder: "Username" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("input", { onChange: (e2) => setEmail(e2.target.value), placeholder: "Email" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: handleSubmit, children: "Submit User" }),
    JSON.stringify(user)
  ] });
}
const pages = [
...
function Navbar() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center justify-center", children: pages.map((page) => {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "m-6 p-6 border-2 border-black rounded-lg", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: page.path, children: page.name }) });
  }) });
}
function Layout() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
